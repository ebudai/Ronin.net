...
/*internal class ReferenceOld : Syntax, IParsable
{
    internal List<Entity> Name { get; init; } = new();

    internal ReferenceOld(Parser parser, int length) : base(parser, length) { }
    ...
    public static Syntax Parse(Parser parser)
    {
        ...
        while (length != parser.Length)
        {
            ...
            else if (lexeme is OpenParenthesis)
            {
                ...
                if (syntax is Aggregate aggregate)
                {
        ...
        return entities.Count is 0 
            ...
            : new ReferenceOld(parser, length) { Name = entities };
    }
}*/
