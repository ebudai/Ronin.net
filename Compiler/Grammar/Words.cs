...
/// <summary>
///     The part of an <see cref="Name"/> or <see cref="Reference"/> which is not being used for <see cref="Compound.Parameters"/> and <see cref="Compound.Inputs"/>
/// </summary>
internal class Words : Syntax, IParsableSyntax<Words>
{
    public static Words Parse(scoped ref Parser current)
    {
        ...
        return new Words { Source = parser.Commit(ref current) };
    }
}