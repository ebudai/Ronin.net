...
137 design documents · 137 headed · 11 measurements · 0 awaiting a header · 84 audit reports (excluded).
...
- **INFERENCEPASS** — A plan for the step-4 inference pass: the three-phase gather/infer/check shape that lets an omit…
