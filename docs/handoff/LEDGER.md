...
134 design documents · 134 headed · 11 measurements · 0 awaiting a header · 84 audit reports (excluded).
...
- **MIDSESSIONMONOMORPH** — Flags mid-session monomorphisation as undesigned, per `CHECKERSCOPINGRULINGS` §9, and asks for i…
