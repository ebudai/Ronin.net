...
143 design documents · 143 headed · 11 measurements · 0 awaiting a header · 85 audit reports (excluded).
...
- **DISCARDEDKINDS** — The `NULLARYRULING` §4 sweep found the fourth structural proxy (fixed) and two more instances of…
