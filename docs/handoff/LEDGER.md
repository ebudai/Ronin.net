...
131 design documents · 131 with a ledger header · 0 awaiting one · 84 audit reports (excluded).
...
- **TYPEHALFDECISIONS** — The type half — four things to rule before it lands
- **TYPEHALFRULINGS** — The type half — four rulings, and they are not independent
...
## Pass 2 worklist — supersession not yet checked (114)
