...
- identifier is a ***words***
- modifiers is one or more of `compiled`, `optional`, `shared`, `persistent`
...
- modifiers is one or more of `hidden`, `shared`
...
A collection of zero or more specific syntax
